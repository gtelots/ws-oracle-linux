...
# Configuration
readonly TOOL_NAME="k6"
readonly TOOL_VERSION="${K6_VERSION:-1.2.2}"
...
install_tool(){
  ...
  local download_url="https://github.com/grafana/k6/releases/download/v${TOOL_VERSION}/k6-v${TOOL_VERSION}-${os}-${arch}.tar.gz"
