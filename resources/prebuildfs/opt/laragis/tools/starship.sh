...
readonly TOOL_VERSION="${STARSHIP_VERSION:-1.23.0}"
...
install_tool(){
  ...
  local download_url="https://github.com/starship/starship/releases/download/v${TOOL_VERSION}/starship-${arch}-unknown-${os}-gnu.tar.gz"
