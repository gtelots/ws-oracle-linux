...
readonly TOOL_VERSION="${HELM_VERSION:-3.18.6}"
...
install_tool(){
  ...
  local download_url="https://get.helm.sh/helm-v${TOOL_VERSION}-${os}-${arch}.tar.gz"
  ...
  install -m 0755 "${temp_dir}/linux-amd64/${TOOL_NAME}" "${INSTALL_DIR}/${TOOL_NAME}"
