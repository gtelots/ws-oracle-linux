...
# Configuration
readonly TOOL_NAME="fd"
readonly TOOL_VERSION="${FD_VERSION:-10.2.0}"
...
install_tool(){
  ...
  # fd uses different architecture naming
  case "$arch" in
    "amd64") arch="x86_64" ;;
    "arm64") arch="aarch64" ;;
  esac
  
  local download_url="https://github.com/sharkdp/fd/releases/download/v${TOOL_VERSION}/fd-v${TOOL_VERSION}-${arch}-unknown-${os}-gnu.tar.gz"
