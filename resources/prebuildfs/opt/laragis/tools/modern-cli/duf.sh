...
# Configuration
readonly TOOL_NAME="duf"
readonly TOOL_VERSION="${DUF_VERSION:-0.8.1}"
...
install_tool(){
  ...
  # duf uses different architecture naming
  case "$arch" in
    "amd64") arch="x86_64" ;;
    "arm64") arch="arm64" ;;
  esac
  
  local download_url="https://github.com/muesli/duf/releases/download/v${TOOL_VERSION}/duf_${TOOL_VERSION}_${os}_${arch}.tar.gz"
